...
#define DUEL_MODE_MR2          (DUEL_TRAP_MONSTERS_NOT_USE_ZONE | DUEL_1_FACEUP_FIELD | DUEL_RETURN_TO_EXTRA_DECK_TRIGGERS | DUEL_TRIGGER_ONLY_IN_LOCATION)
